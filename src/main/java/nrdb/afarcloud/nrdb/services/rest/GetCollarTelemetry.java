...
public class GetCollarTelemetry {
    ...
    public Response getLatestCollarTelemetry(    			
    		...
    		HashMap<String, String> hConditions = TelemetryExtractor.getCollarConditions(nLimit, sEntityNames, sServices, sTypes, sProviders, sAnomalies, sAlarm, nAltitude, sOrder, csvFormat);
    		return TelemetryExtractor.getOMTelemetry(request, Constants.IDB_COLLAR_MEASUREMENT, hConditions, false);
