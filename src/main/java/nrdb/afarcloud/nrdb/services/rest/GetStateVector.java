...
public class GetStateVector {
    ...
    public Response getLatestStateVector(    			
    			@Parameter(in = ParameterIn.QUERY, description = "Number of state vectors to retrieve. Default 1, maximum defined by services provider.", required = true )
    		...
    		HashMap<String, String> hConditions = TelemetryExtractor.getStateVectorConditions(nLimit, sVehiclesId, sOrder, csvFormat);
    		return TelemetryExtractor.getOMTelemetry(request, Constants.IDB_VEHICLE_MEASUREMENT, hConditions, false);
    ...
    public Response getHistoricStateVector(    			
