...
public class Command implements org.apache.thrift.TBase<Command, Command._Fields>, java.io.Serializable, Cloneable, Comparable<Command> {
  ...
  public Command setStartTime(int startTime) {
    this.startTime = startTime;
    setStartTimeIsSet(true);
    return this;
  }
  ...
  public Command setEndTime(int endTime) {
    this.endTime = endTime;
    setEndTimeIsSet(true);
    return this;
  }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Command struct) throws org.apache.thrift.TException {
      ...
      if (struct.params != null) {
        oprot.writeFieldBegin(PARAMS_FIELD_DESC);
        {
          ...
          for (double _iter35 : struct.params)
          {
      ...
      if (struct.isSetParams()) {
        {
          ...
          for (double _iter36 : struct.params)
          {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.params = new ArrayList<Double>(_list37.size);
          double _elem38;
