            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.forbiddenArea = new ArrayList<Region>(_list40.size);
                Region _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = new Region();
                  _elem41.read(iprot);
                  struct.forbiddenArea.add(_elem41);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.homeLocation = new ArrayList<Position>(_list43.size);
                Position _elem44;
                for (int _i45 = 0; _i45 < _list43.size; ++_i45)
                {
                  _elem44 = new Position();
                  _elem44.read(iprot);
                  struct.homeLocation.add(_elem44);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tasks = new ArrayList<Task>(_list46.size);
                Task _elem47;
                for (int _i48 = 0; _i48 < _list46.size; ++_i48)
                {
                  _elem47 = new Task();
                  _elem47.read(iprot);
                  struct.tasks.add(_elem47);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.vehicles = new ArrayList<Vehicle>(_list49.size);
                Vehicle _elem50;
                for (int _i51 = 0; _i51 < _list49.size; ++_i51)
                {
                  _elem50 = new Vehicle();
                  _elem50.read(iprot);
                  struct.vehicles.add(_elem50);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commands = new ArrayList<Command>(_list52.size);
                Command _elem53;
                for (int _i54 = 0; _i54 < _list52.size; ++_i54)
                {
                  _elem53 = new Command();
                  _elem53.read(iprot);
                  struct.commands.add(_elem53);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Mission struct) throws org.apache.thrift.TException {
      ...
      if (struct.forbiddenArea != null) {
        oprot.writeFieldBegin(FORBIDDEN_AREA_FIELD_DESC);
        {
          ...
          for (Region _iter55 : struct.forbiddenArea)
          {
            _iter55.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.homeLocation != null) {
        oprot.writeFieldBegin(HOME_LOCATION_FIELD_DESC);
        {
          ...
          for (Position _iter56 : struct.homeLocation)
          {
            _iter56.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.vehicles != null) {
        oprot.writeFieldBegin(VEHICLES_FIELD_DESC);
        {
          ...
          for (Vehicle _iter58 : struct.vehicles)
          {
            _iter58.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.commands != null) {
        if (struct.isSetCommands()) {
          oprot.writeFieldBegin(COMMANDS_FIELD_DESC);
          {
            ...
            for (Command _iter59 : struct.commands)
            {
              _iter59.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetForbiddenArea()) {
        {
          ...
          for (Region _iter60 : struct.forbiddenArea)
          {
            _iter60.write(oprot);
          }
        }
      ...
      if (struct.isSetHomeLocation()) {
        {
          ...
          for (Position _iter61 : struct.homeLocation)
          {
            _iter61.write(oprot);
          }
        }
      ...
      if (struct.isSetVehicles()) {
        {
          ...
          for (Vehicle _iter63 : struct.vehicles)
          {
            _iter63.write(oprot);
          }
        }
      ...
      if (struct.isSetCommands()) {
        {
          ...
          for (Command _iter64 : struct.commands)
          {
            _iter64.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.forbiddenArea = new ArrayList<Region>(_list65.size);
          Region _elem66;
          for (int _i67 = 0; _i67 < _list65.size; ++_i67)
          {
            _elem66 = new Region();
            _elem66.read(iprot);
            struct.forbiddenArea.add(_elem66);
          }
        }
        struct.setForbiddenAreaIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.homeLocation = new ArrayList<Position>(_list68.size);
          Position _elem69;
          for (int _i70 = 0; _i70 < _list68.size; ++_i70)
          {
            _elem69 = new Position();
            _elem69.read(iprot);
            struct.homeLocation.add(_elem69);
          }
        }
        struct.setHomeLocationIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.tasks = new ArrayList<Task>(_list71.size);
          Task _elem72;
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.vehicles = new ArrayList<Vehicle>(_list74.size);
          Vehicle _elem75;
          for (int _i76 = 0; _i76 < _list74.size; ++_i76)
          {
            _elem75 = new Vehicle();
            _elem75.read(iprot);
            struct.vehicles.add(_elem75);
          }
        }
        struct.setVehiclesIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.commands = new ArrayList<Command>(_list77.size);
          Command _elem78;
          for (int _i79 = 0; _i79 < _list77.size; ++_i79)
          {
            _elem78 = new Command();
            _elem78.read(iprot);
            struct.commands.add(_elem78);
          }
        }
        struct.setCommandsIsSet(true);
      }
